...
console.log(summerMessage.toLocaleLowerCasa())
...
console.log(winterMessage.toLocaleLowerCase())
...
const realBestMovie='E o Oscar de meljor filme vai para:'
/*
...
const allEpisodes =`0 nº de episódios é:`${episodes}
